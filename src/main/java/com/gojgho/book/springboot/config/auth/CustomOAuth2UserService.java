...
import com.gojgho.book.springboot.config.auth.dto.OAuthAttributes;
import com.gojgho.book.springboot.config.auth.dto.SessionUser;
import com.gojgho.book.springboot.domain.user.User;
...
<OAuth2UserRequest, OAuth2User>{
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        OAuthAttributes attributes = OAuthAttributes.of
                (registrationId, userNameAttributeName, oAuth2User.getAttributes()); //3
