package com.gojgho.book.springboot.service;

import com.gojgho.book.springboot.domain.posts.Posts;
import com.gojgho.book.springboot.domain.posts.PostsRepository;
...
public class PostsService {
    ...
    public List<PostsListResponseDto> findAllDesc(){
        return postsRepository.findAllDesc().stream()
                .map(PostsListResponseDto::new)  //PostsListResponseDto::new => posts -> new PostsListResponseDtp(posts)
